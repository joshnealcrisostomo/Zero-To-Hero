 ...
 */
public class HotelViewGUI extends JPanel {
    /**
     ...
     */
    public HotelViewGUI(MainGUI mainFrame) {
    ...
    private void displayGUI() {
        ...
        managHotelLbl.setText("Hotel Viewing ");
        ...
        askHotelToManage.setText("Which hotel would you like to view?");
    ...
    /**
     * $$$getRootComponent$$$ method that returns the root component of the GUI.
     *
    ...
    /**
     * setActionListener method that sets the action listener for menu and view buttons.
     *
    ...
    /**
     * getHotelToView method that returns the hotel name input from the text field.
     *
     * @return The text entered in the hotelNameFld text field.
     */
    public String getHotelToView() {
        return hotelNameFld.getText();
    }

    /**
     * setErrorMessage method that displays an error message in a dialog box.
     *
    ...
    /**
     * setHotelList method that sets the text of the displayHotels component.
     *
     * @param hotelList The list of hotels to be displayed.
     */
    public void setHotelList(String hotelList) {
        displayHotels.setText(hotelList);
    }
